...
public class Factura {
	...
	private  int id_reserva_recreacion_fk;
	...
	public Factura(int id, int id_cliente_fk, int id_habitacion_fk, LocalDate fecha_entrada, LocalDate fecha_salida,
			int id_reserva_recreacion_fk, int costoXhabitacion, int costoXrecreacion, double costo_final, double descuento) {
		super();
		this.id = id;
		...
		this.id_reserva_recreacion_fk = id_reserva_recreacion_fk;
	...
	public Factura(int id, int id_cliente_fk, int id_habitacion_fk, LocalDate fecha_entrada, LocalDate fecha_salida,
			int id_reserva_recreacion_fk, int costoXhabitacion, int costoXrecreacion, double costo_final) {
		super();
		this.id = id;
		this.id_cliente_fk = id_cliente_fk;
		this.id_habitacion_fk = id_habitacion_fk;
	...
	public int getid_reserva_recreacion_fk() {
		return id_reserva_recreacion_fk;
	}
	public void setid_reserva_recreacion_fk(int id_reserva_recreacion_fk) {
		this.id_reserva_recreacion_fk = id_reserva_recreacion_fk;
	}
	...
	public String toString() {
		return "Factura [id=" + id + ", id_cliente_fk=" + id_cliente_fk + ", id_habitacion_fk=" + id_habitacion_fk
				+ ", fecha_entrada=" + fecha_entrada + ", fecha_salida=" + fecha_salida + ", id_reserva_recreacion_fk="
				+ id_reserva_recreacion_fk + ", costoXhabitacion=" + costoXhabitacion + ", costoXrecreacion="
